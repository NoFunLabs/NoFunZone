...
async function mintNFT(element) {
  ...
  document.getElementById('moduleTestBottom').textContent = "MINTING"
  var loop_count = 1;
  while ( !transactionReceipt ) {
    ...
    if (loop_count > 3) {
      ...
      document.getElementById('moduleTestBottom').insertAdjacentText('beforeEnd', '.');
    }
  ...
  document.getElementById('moduleTestBottom').textContent = "MINT SUCCESS!"
        ...
        <div className='moduleTestBox' id='moduleTestBox'>
          ...
          <div className='moduleTestBottom' id='moduleTestBottom'>
            <div className='moduleTestEvolveButton' id='moduleTestEvolveButton' onClick={handleEvolveClick}>
              ...
              <div className='moduleTestEvolveButtonText' id='moduleTestEvolveButtonText'>{(isConnected) ? 'Evolve' : 'Connect Wallet'}</div>
            </div>
          </div>
        </div>
      </div>
