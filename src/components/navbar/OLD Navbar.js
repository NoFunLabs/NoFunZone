...
function handleSubmitClick () {
  const alchemy = alchemizer.alchemize(astrologize());
  console.log(alchemy);
}
...
function astrologize() {
  ...
  if (useDefaultBirthday) {
    if (useDefaultBirthday === "Evan") {
      origin = new Origin({
        year: 1990,
    ...
    } else if (useDefaultBirthday === "Greg") {
      origin = new Origin({
        year: 1991,
        ...
        <div className='navbarBox'>
          ...
          <div className='birthInfoForm' id='birthInfoForm'>
            ...
            <div className='birthLocationInputContainer' id='birthLocationInputContainer'>
              ...
              <input className="submitButton" id="submitButton" type="submit" value="Submit" onClick={handleSubmitClick}/>
            </div>
